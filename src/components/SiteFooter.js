  ...
  return (
    <footer className="bg-hello text-world mt-auto py-8">
      <div className="flex container mx-auto justify-between items-center">
        ...
        <span className="font-sans tracking-widest text-xs font-semibold">
          © 2020 Obvious
        </span>
        <ul className="flex w-1/4 justify-between">
          ...
          <a href="https://github.com/obvious/">
            <svg className="fill-current h-4" viewBox="0 0 496 512">
          ...
          <a href="https://www.linkedin.com/company/obvious-hq/">
            <svg className="fill-current h-4" viewBox="0 0 448 512">
